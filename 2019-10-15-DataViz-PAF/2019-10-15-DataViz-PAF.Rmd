...
theme_mati <- theme_gray(base_size = 14, base_family = "")
...
wrong_y + coord_cartesian(ylim=c(90,100)) 
...
cowplot::plot_grid(wrong_y + coord_cartesian(ylim=c(90,100)), wrong_y, 
...
```{r}
include_graphics("img/treemap.png")
```
...
* Pay attention to the order of bar plots.
* Use direct labeling & get rid of legends. 
* Use color responsably. Mind diversity in color perception and monochrome prints. 
